...
if __name__ == '__main__':
    ...
    # print(timeer0)
    # exit()
    df_time_list = [['2019-1-01 09:15:00', '2019-12-27 16:25:00']]
    ...
    if True == a:
        ...
        resdf,res0 = duojincheng_backtesting(df000, zong_can=[[40.0, 130.0, 290.0, 16.0, 1.0]], strat_time=strat_time, end_time=end_time, cpu_nums = 1)
        print(res0)
        print(resdf.tail(5))
        ...
        if mode == 1:
            ...
            draw_charts(resdf,canshu={'opne_price':resdf['opne_price'],
                        ...
                        },vol_bar=True, markline_show2=True,path=r'html_gather\max_突破06_固定_%s_test'%timeer0)
        if mode == 2:
            draw_charts(resdf,canshu={'opne_price':resdf['opne_price'],
                                  '止损价' :resdf['止损价'],
                                  '止盈价':resdf['止盈价'],
                                  ...
                                  "atr_day":resdf['atr_day']
                        },vol_bar=True, markline_show2=True,path=r'html_gather\max_突破06_固定_%s'%timeer0)
        print(f'总时间：{time.process_time() - time0}  s')
    #多进程策略 :
    if True == b:
        [50, 130, 270, 20, 2]
        canshu_list = []
        for cs1 in range(30, 80, 10):
            for cs2 in range(100, 231, 10):
                for cs3 in range(150, 351, 10):
        ...
        print(resdf.tail())
        resdf.to_csv(r'csv_gather\max_突破06_固定_%s.csv'%timeer0)
        print(f'总时间：{time.process_time() -time0}  s')
    ...
    if True == c:
        ...
        name = 'max_突破06_固定_2015_2019'

        if True == 0:
            [50, 130, 270, 20, 2]
            canshu_list = []
            for cs1 in range(30, 60, 10):
                for cs2 in range(120, 160, 10):
                    for cs3 in range(260, 311,10):
