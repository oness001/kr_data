        ...
        if trading_time_con :
            ...
            if we_trade_con:
                if now_pos == 0:
                    ...
                    # print(df0[i, 7],df0[i, 8],inner_trade_nums)
                    # 空：突破最低线。
...
if __name__ == '__main__':
    ...
    if True == a:
        ...
        resdf,res0 = duojincheng_backtesting(df000, zong_can=[[50,130,270,0]], strat_time=strat_time, end_time=end_time, cpu_nums = 1)
        ...
        draw_charts(resdf,canshu={'opne_price':resdf['opne_price'],
                        ...
                        },vol_bar=True, markline_show2=True,path=r'html_gather\1130_%s'%timeer0)
        print(res0)
    ...
    if True == b:
        ...
        for cs1 in range(30, 80, 5):
            for cs2 in range(120, 231, 10):
                for cs3 in range(150, 351, 10):
                        for cs4 in range(0, 2, 1):
        ...
        print(resdf.tail())
        resdf.to_csv(r'csv_gather\numba_突破max01_策略01_%s.csv'%timeer0)
        print(f'总时间：{time.process_time() -time0}  s')