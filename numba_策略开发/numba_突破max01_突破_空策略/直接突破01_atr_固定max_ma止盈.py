...
def cal_signal_(df0, df1, df2, strat_time, end_time, cs0, sxf=1, slip=1):
    ...
    stop_win_n, ma_len, atrn,sw_atrn, trade_inner_nums = cs0
    # 配置临时变量
...
if __name__ == '__main__':
    ...
    if True == a:
        ...
        # time.sleep(0.2)
        resdf, res0 = duojincheng_backtesting(df000, zong_can=[[130, 16,4,1,1]],
                                              strat_time=strat_time,
    ...
    if True == c:
        ...
        canshu_list = []
        for cs1 in [195,200,205,210,215,220,225,260,265,270]:
            for cs2 in range(17, 25, 2):
                for cs3 in range(2, 5, 1):
