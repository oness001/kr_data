...
if __name__ == '__main__':
    ...
    if True == c:
        ...
        canshu_list = []
        for cs1 in range(210, 230, 2):
            for cs2 in range(20, 26, 1):
                for cs3 in range(3, 5, 1):
                    for cs4 in range(4, 5, 1):
                        for cs5 in range(3100, 4001, 200):
        ...
        strat_time = np.array([1, 9, 30])
        end_time = np.array([27, 16, 10])
        name = f'{filename}_{s_time[:4]}_{e_time[:4]}_5min_精细'
