...
if __name__ == '__main__':
    ...
    c = 1
    if True == a:
        df_time_list = [['2019-9-10 09:15:00', '2019-12-20 16:25:00']]
        ...
        4000.000
        1.000
        resdf, res0 = duojincheng_backtesting(df000, zong_can=[[180,20,3000,1,3]],
                                              strat_time=strat_time,
    ...
    if True == c:
        ...
        canshu_list = []
        for cs1 in range(190, 231, 5):
            for cs2 in range(16, 25, 2):
                for cs3 in range(2000,4001,500):
                    for cs4 in range(1, 5, 1):
