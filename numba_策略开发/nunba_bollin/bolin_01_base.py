...
if __name__ == '__main__':
    ...
    if True == a:
        ...
        resdf, res0 = duojincheng_backtesting(df000, zong_can=[[215.0, 13.0, 130.0, 4.0, 10.0]],
    ...
    if True == b:
        ...
        canshu_list = []
        for cs1 in range(190, 230, 5):
            for cs2 in range(13, 17, 1):
                for cs3 in [i for i in range(100, 140, 10)]+[500,510,520,550]:
                    for cs4 in range(20, 51, 5):
