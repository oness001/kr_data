...
def cal_signal_(df0, df1, df2, strat_time, end_time, cs0, sxf=1, slip=1):
    ...
    for i in range(10, df0.shape[0]):  # 类似于vnpy:on_bar
        ...
        if trading_time_con:
            ...
            if we_trade_con:
                if now_pos == 0:
                    long_condition =  (clsoe_bar < dn_1) and (last_close >= dn_1) and (ma_xiao<da_ma)
...
if __name__ == '__main__':
    ...
    if True == a:
        ...
        resdf, res0 = duojincheng_backtesting(df000, zong_can=[[200.0, 15.0, 500.0, 3.0, 1.0]],
