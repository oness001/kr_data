...
from numba_策略开发.功能工具.因子库 import rsi_cci_atr01 ,std_zdf_tp2
...
def cal_signal(df,strat_time,end_time,cs0,ix_zong=100,all_day=0):
    ...
    #  ===指标数据
    df['tp'] = std_zdf_tp2(df, int(cs0[0]), float(cs0[2]), int(cs0[0]))
    ...
    df['zuheyinzi'] = df['zuheyinzi'] - df['zuheyinzi'].shift(1)
    df['zuheyinzi'] = df['zuheyinzi'].rolling(int(cs0[0])).mean()
...
if __name__ == '__main__':
    ...
    if True == a:
        ...
        df_time_list = [['2016-1-1 09:15:00', '2016-12-10 16:25:00']]
