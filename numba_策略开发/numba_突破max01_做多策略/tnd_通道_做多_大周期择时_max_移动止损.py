...
if __name__ == '__main__':
    ...
    if True == a:
        ...
        resdf, res0 = duojincheng_backtesting(df000, zong_can=[[200.0, 19.0, 2000.0, 4.0, 1.0]],
    ...
    # [190, 20, 2, 2]
    if True == b:
        # [200.0, 19.0, 2000.0, 4.0, 1.0]
        canshu_list = []
        for cs1 in range(180, 231, 10):
            for cs2 in range(15, 25, 2):
                for cs3 in range(2000, 3001, 300):
                    for cs4 in range(3, 6, 1):
                        for cs5 in range(1, 3, 1):
                            canshu_list.append([cs1, cs2, cs3, cs4,cs5])
        canshu_list = canshu_list[:]
        to_csv_path = r'csv_gather\%s_%s_1min_16-19粗粒度回测.csv' % (filename,timeer0)
