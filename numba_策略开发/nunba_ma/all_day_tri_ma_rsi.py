...
if __name__ == '__main__':
    ...
    c = 10
    if True == a:
        df_time_list = [['2017-1-10 09:15:00', '2019-12-10 16:25:00']]
        ...
        resdf, res0 = duojincheng_backtesting(df000, zong_can=[[40, 140, 30, 50.0,140,50]],
    ...
    def 李_策略3_换个自适应布林通道构建2_参数2(data, para=[90, 2]):
        df = data.copy()
