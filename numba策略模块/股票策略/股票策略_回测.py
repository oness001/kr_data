...
from numba_策略开发.回测工具.股票回测模型  import cal_per_pos
...
@jit(nopython=True)
def cal_per_pos(i, df1: np.array, open_pos_size, open_bar, clsoe_bar, last_close, sxf=2/1000, slip=2/1000):
    '''
...
def cal_signal_(df0, df1, df2, strat_time, end_time, cs0, sxf=2/1000, slip=2/1000):
    '''
    df1:所有的基础数据：时间，名称，ohlcv—vc，是否可买入，统一平仓日，统一换仓日
    df2：对应的仓位利润：时间，名称，是否选中，是否持仓，持仓价格，持仓股数，
                        持仓金额，持仓利润率，持仓利润，单日涨跌幅，单日浮动盈亏，手续费，滑点金额
    '''
